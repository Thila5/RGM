                ...
                <div class="p-8 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('projectMilestones.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <select name="research_grant_id" id="research_grant_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-md focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100 hover:bg-purple-700 transition duration-300 ease-in-out">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="milestone_name" id="milestone_name" class="mt-1 block w-full border-gray-300 rounded-md shadow-md focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100 hover:bg-purple-700 transition duration-300 ease-in-out" required>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="deliverable" id="deliverable" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-md focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100 hover:bg-purple-700 transition duration-300 ease-in-out" required></textarea>
                            @error('deliverable')
                                <div class="text-red-500 text-xs mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="remark" id="remark" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-md focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100 hover:bg-purple-700 transition duration-300 ease-in-out"></textarea>
                        </div>
